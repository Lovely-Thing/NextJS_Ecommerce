...
export default function CheckoutLists(_props:any) {
    ...
    return(
        <Component>
                    ...
                    <div className="collaps_header_top">
                        ...
                        <div className="ch_item_texts">
                            ...
                            <div className="ch_bottom">
                                ...
                                <u onClick={showModal}>5 options</u>
                            </div>
                        </div>
                    </div>
            ...
            <Modal title="Edit option" visible={isModalVisible} onOk={handleOk} onCancel={handleCancel} cancelText="Back" okText="Continue" className="editoptionmodal">
                <BodyText01 text='The price of the goods is displayed per m3.'/>
                <div className="optionItems">
                    <div className="option_item">
                        <div className="item_wrap">
                            <p>1% Accelerator</p>
                            <div>
                                <label htmlFor="">$12.00/unit</label>
