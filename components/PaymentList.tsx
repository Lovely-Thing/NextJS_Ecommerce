...
export default function PaymentList(_props:any) {
    ...
    return(
        <Component>
            ...
            >
                ...
                <Panel header={activeTabs.length > 0 && activeTabs.indexOf('2') !==-1?"Hide fee and taxes details":"Show fee and taxes details"} key={2} className="site-collapse-custom-panel" id="testp">
                    <OverlineText text="ORDER"/>
                    <div className="detail_content">
                        <div className=""> 
                            <SubTitle02 text='Agregate and stone'/> 
                ...
                <Panel header={activeTabs.length > 0 && activeTabs.indexOf('3') !==-1?"Hide fee and taxes details":"Show fee and taxes details"} key={3} className="site-collapse-custom-panel" id="testp">
                    <OverlineText text="ORDER"/>
                    <div className="detail_content">
                        <div className=""> 
                            <SubTitle02 text='Agregate and stone'/> 
